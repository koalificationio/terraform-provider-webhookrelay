...
func (o *GetV1FunctionsOK) Error() string {
	return fmt.Sprintf("[GET /v1/functions][%d] getV1FunctionsOK  %+v", 200, o.Payload)
}
...
func (o *GetV1FunctionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
